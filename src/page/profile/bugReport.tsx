...
export default function BugReportScreen() {
  ...
  const onSubmit = async (data: BugReportFormData) => {
    try {
          ...
          const response = await userApi.add(validatedData, 'BUG');
          console.log(
            'Bug report submitted successfully for user: ' +
          ...
          const errorMessage =
            ...
            error?.message ||
            'An error occurred during bug report submission';
          console.log('Body:', JSON.stringify(error?.response?.data));
          console.error('Bug report submission error:', errorMessage);
        } finally {
