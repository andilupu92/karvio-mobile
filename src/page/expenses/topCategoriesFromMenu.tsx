          ...
          return (
            <View key={item.categoryName} className="flex-row items-center justify-between mb-3">
              ...
              <View className="flex-row items-center flex-1">
                ...
                />
                <Text
                  className={`${isDark ? 'text-typography-900' : 'text-typography-100'} font-inter-medium text-sm`}
                >
                  {item.categoryName}
                </Text>
              </View>
              ...
              <Text
                className={`${isDark ? 'text-typography-800' : 'text-typography-100'} font-inter-regular text-sm`}
              >
                {' '}
                %
              </Text>
