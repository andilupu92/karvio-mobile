        ...
        const responseData = [
          {
            monthName: 'ianuarie',
            totalAmount: 750,
            categorySummaryResponseList: [{ categoryName: 'Service&Piese', totalAmount: 750 }],
            carResponsesList: [
              {
                car: {
                  id: 3,
          ...
          },
          {
            monthName: 'februarie',
            totalAmount: 540,
            categorySummaryResponseList: [{ categoryName: 'Amenzi', totalAmount: 540 }],
            carResponsesList: [
              {
                car: {
                  id: 17,
          ...
          },
          {
            monthName: 'aprilie',
            totalAmount: 2095,
            categorySummaryResponseList: [
              { categoryName: 'ITP', totalAmount: 700 },
              { categoryName: 'Rovinietă', totalAmount: 460 },
              { categoryName: 'Impozit auto', totalAmount: 340 },
            ],
            carResponsesList: [
              {
                car: {
          ...
          },
          {
            ...
            totalAmount: 7067,
            categorySummaryResponseList: [
              { categoryName: 'Combustibil', totalAmount: 4380 },
              { categoryName: 'Impozit auto', totalAmount: 700 },
              { categoryName: 'Trusă medicală', totalAmount: 660 },
            ],
            carResponsesList: [
              {
                car: {
