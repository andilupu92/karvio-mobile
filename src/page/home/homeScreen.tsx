...
export default function HomeScreen() {
      ...
      const responseData = [
        {
          ...
          expenseResponseList: [
            ...
            },
            {
              id: 7,
              expenseTypeId: 6,
              expenseTypeName: 'Impozit auto',
              expenseTypeIconName: 'receipt',
        ...
        },
        {
          ...
          expenseResponseList: [
            ...
            },
            {
              id: 17,
              expenseTypeId: 7,
              expenseTypeName: 'Extinctor',
              expenseTypeIconName: 'FireExtinguisher',
  ...
  return (
    ...
    >
            ...
            <View key={cars.length} className="flex-1 w-full">
              ...
              <View className="flex-row px-4 gap-3 mb-3">
                <HomeExpenses
                  ...
                  onExpensesPress={() =>
                    navigation.navigate('ExpensesDetail', { car, cars, expenses })
                  }
                />
                <HomeHealth healthScore={car.healthScore} />
              </View>
              <HomeDocuments
                documents={documents.slice(0, 3)}
                onDocumentPress={(document) =>
                  navigation.navigate('DocumentDetail', { car, document, cars })
                }
              />
            </View>
          ) : (
      ...
      <AddFuel visible={showAddFuel} carId={car.id} onClose={() => setShowAddFuel(false)} />
    </SafeAreaView>
  );
}
