...
const insertFuelSchema = z.object({
  ...
  liters: z.coerce
    .number()
    .min(1, 'Litri este obligatoriu')
    .positive('Litri trebuie să fie un număr pozitiv'),
        ...
        >
          ...
          >
            ...
            <View className="flex-row items-center justify-between mb-6">
              <Text
                className={`text-xl font-inter-bold ${isDark ? 'text-typography-900' : 'text-typography-100'}`}
              >
                Add Fuel
              </Text>
              <TouchableOpacity
              ...
              >
                <Icons.X className="text-error-50" size={18} strokeWidth={2.5} />
              </TouchableOpacity>
            </View>
