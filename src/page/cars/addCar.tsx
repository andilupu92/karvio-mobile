      ...
      >
        ...
        >
          ...
          <FormControl isInvalid={!!errors.energyType} style={{ zIndex: 999 }}>
            ...
            />
            <FormControlError>
              <Text className="ml-2 mt-1 text-xs text-red-500">{errors.energyType?.message}</Text>
            </FormControlError>
          </FormControl>
